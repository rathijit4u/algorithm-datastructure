...
from sorting.selection_sort import selection_sort_simple
from util.function_timer import timer


class SelectionSortTest(BaseSortingTest):
    """
    ...
    def sort(self, arr):
        ...
        selection_sort_simple(sorted_arr)
        self.assertEqual(sorted(arr), sorted_arr)


if __name__ == '__main__':
    # Run all unit tests
    #  python -m unittest sorting.test_selection_sorting.SelectionSortTest
    unittest.main()
